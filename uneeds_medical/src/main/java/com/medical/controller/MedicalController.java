...
import com.medical.mongo.MongoUtil;
...
public class MedicalController {
	...
	public String insertSido(SidoVO vo) {
		dao.insertSido(vo);
		return "saveAPI_test";
	}
	...
	public String insertSigun(SigunVO vvo) {
		dao.insertSigun(vvo);
		return "saveAPI_test";
	}
	...
	public String insertKinds(KindsVO ko) {
		dao.insertKinds(ko);
		return "saveAPI_test";
	}
	...
	public String insertThema(ThemaVO to) {
		dao.insertThema(to);
		return "saveAPI_test";
	}
	...
	public String insertBigbirds(MedicalVO m, RedirectAttributes rattr, HttpServletRequest r) {
		...
		Document doc = new Document("dutyAddr", m.getAddr()).append("dutyName", m.getName())
				.append("dutyMapimg", m.getMaping()).append("dutyTel1", m.getNumber())
				.append("dutyTime1s", m.getMs_time()).append("dutyTime1c", m.getMc_time())
				.append("dutyTime2s", m.getTs_time()).append("dutyTime2c", m.getTc_time())
				.append("dutyTime3s", m.getWs_time()).append("dutyTime3c", m.getWc_time())
				.append("dutyTime4s", m.getThs_time()).append("dutyTime4c", m.getThc_time())
				.append("dutyTime5s", m.getFs_time()).append("dutyTimeFc", m.getFc_time())
				.append("dutyTime6s", m.getSs_time()).append("dutyTime6c", m.getSc_time())
				.append("hpid", m.getMedicalid()).append("wgs84Lat", m.getMap_x()).append("wgs84Lon", m.getMap_y());
	...
	public ResponseEntity<String> hospitalSidoCode(HttpServletRequest request) throws Exception {
		StringBuilder urlBuilder = new StringBuilder(
				"http://apis.data.go.kr/B551182/codeInfoService/getAddrCodeList"); /* URL */
		urlBuilder.append("?" + URLEncoder.encode("ServiceKey", "UTF-8")
				+ "=h1WoDyOi4e8rhTTYSuSJmN5H5sMOoJZhuTOsYTgxzzOEJaarD%2FrWJBttt15QA9Dw5h9Tj4%2BslQNc7eTa49aOOg%3D%3D"); /*
																														 * Service
																														 * Key
																														 */
		...
		urlBuilder.append("&" + URLEncoder.encode("addrTp", "UTF-8") + "="
				+ URLEncoder.encode("1", "UTF-8")); /* 1:시도, 2:시군구, 3:읍면동 */
		urlBuilder.append("&" + URLEncoder.encode("sidoCd", "UTF-8") + "="
				+ URLEncoder.encode("", "UTF-8")); /* addrTp 2일 경우 입력 */
		urlBuilder.append("&" + URLEncoder.encode("sidoCdNm", "UTF-8") + "="
				+ URLEncoder.encode("", "UTF-8")); /* addrTp 3일 경우 시도명 입력 */
		urlBuilder.append("&" + URLEncoder.encode("sgguCdNm", "UTF-8") + "="
				+ URLEncoder.encode("", "UTF-8")); /* addrTp 3일 경우 시도명 입력 */
	...
	public ResponseEntity<String> hospitalSigunCode(HttpServletRequest request) throws Exception {
		StringBuilder urlBuilder = new StringBuilder(
				"http://apis.data.go.kr/B551182/codeInfoService/getAddrCodeList"); /* URL */
		urlBuilder.append("?" + URLEncoder.encode("ServiceKey", "UTF-8")
				+ "=h1WoDyOi4e8rhTTYSuSJmN5H5sMOoJZhuTOsYTgxzzOEJaarD%2FrWJBttt15QA9Dw5h9Tj4%2BslQNc7eTa49aOOg%3D%3D"); /* Service Key */
		urlBuilder.append("&" + URLEncoder.encode("ServiceKey", "UTF-8") + "=" + URLEncoder.encode(
				"h1WoDyOi4e8rhTTYSuSJmN5H5sMOoJZhuTOsYTgxzzOEJaarD%2FrWJBttt15QA9Dw5h9Tj4%2BslQNc7eTa49aOOg%3D%3D",
				"UTF-8")); /* 공공데이터포털에서 받은 인증키 */
		urlBuilder
		...
		urlBuilder.append("&" + URLEncoder.encode("addrTp", "UTF-8") + "="
				+ URLEncoder.encode("2", "UTF-8")); /* 1:시도, 2:시군구, 3:읍면동 */

		String addrCd = request.getParameter("addrCd");
		addrCd = Objects.isNull(addrCd) ? "110000" : addrCd;
		urlBuilder.append("&" + URLEncoder.encode("sidoCd", "UTF-8") + "="
				+ URLEncoder.encode(addrCd, "UTF-8")); /* addrTp 2일 경우 입력 */
	...
	public ResponseEntity<String> hospitalDongCode(HttpServletRequest request) throws Exception {
		...
		urlBuilder.append("&" + URLEncoder.encode("addrTp", "UTF-8") + "="
				+ URLEncoder.encode("3", "UTF-8")); /* 1:시도, 2:시군구, 3:읍면동 */
		urlBuilder.append("&" + URLEncoder.encode("sidoCd", "UTF-8") + "="
				+ URLEncoder.encode("", "UTF-8")); /* addrTp 2일 경우 입력 */
		...
		urlBuilder.append("&" + URLEncoder.encode("sidoCdNm", "UTF-8") + "="
				+ URLEncoder.encode(sido, "UTF-8")); /* addrTp 3일 경우 시도명 입력 */
		urlBuilder.append("&" + URLEncoder.encode("sgguCdNm", "UTF-8") + "="
				+ URLEncoder.encode(sigun, "UTF-8")); /* addrTp 3일 경우 시도명 입력 */
	...
	public ResponseEntity<String> hospitalKindsCode(HttpServletRequest request) throws Exception {
		StringBuilder urlBuilder = new StringBuilder(
				"http://apis.data.go.kr/B551182/codeInfoService/getMdlrtSbjectCodeList"); /* URL */
		urlBuilder.append("?" + URLEncoder.encode("ServiceKey", "UTF-8")
				+ "=h1WoDyOi4e8rhTTYSuSJmN5H5sMOoJZhuTOsYTgxzzOEJaarD%2FrWJBttt15QA9Dw5h9Tj4%2BslQNc7eTa49aOOg%3D%3D"); /*
																														 * Service
																														 * Key
	...
	public ResponseEntity<String> hospitalThemaCode(HttpServletRequest request) throws Exception {
		StringBuilder urlBuilder = new StringBuilder(
				"http://apis.data.go.kr/B551182/codeInfoService/getMedicInsttClassesCodeList"); /* URL */
		urlBuilder.append("?" + URLEncoder.encode("ServiceKey", "UTF-8")
				+ "=h1WoDyOi4e8rhTTYSuSJmN5H5sMOoJZhuTOsYTgxzzOEJaarD%2FrWJBttt15QA9Dw5h9Tj4%2BslQNc7eTa49aOOg%3D%3D"); /*
																														 * Service
																														 * Key
	...
	public ResponseEntity<String> hospitalInfoView(HttpServletRequest request) throws Exception {
		...
		urlBuilder
				.append("&" + URLEncoder.encode("sidoCd", "UTF-8") + "=" + URLEncoder.encode(sido, "UTF-8")); /* 시도코드 */
		urlBuilder.append(
				"&" + URLEncoder.encode("sgguCd", "UTF-8") + "=" + URLEncoder.encode(sigun, "UTF-8")); /* 시군구코드 */

		urlBuilder.append(
				"&" + URLEncoder.encode("emdongNm", "UTF-8") + "=" + URLEncoder.encode(dong, "UTF-8")); /* 읍면동명 */
		urlBuilder.append("&" + URLEncoder.encode("yadmNm", "UTF-8") + "="
				+ URLEncoder.encode("", "UTF-8")); /* 병원명 (UTF-8 인코딩 필요) */

		urlBuilder.append("&" + URLEncoder.encode("zipCd", "UTF-8") + "=" + URLEncoder.encode("",
				"UTF-8")); /*
							 * 2010:종합병원, 2030:병원, 2040:요양병원, 2050:치과, 2060:한방, 2070:의원, 2080:보건기관, 2090:조산원
							 */

		urlBuilder.append("&" + URLEncoder.encode("clCd", "UTF-8") + "=" + URLEncoder.encode("", "UTF-8")); /* 종별코드 */
		urlBuilder.append(
				"&" + URLEncoder.encode("dgsbjtCd", "UTF-8") + "=" + URLEncoder.encode(kinds, "UTF-8")); /* 진료과목코드 */

		urlBuilder.append(
				"&" + URLEncoder.encode("xPos", "UTF-8") + "=" + URLEncoder.encode("", "UTF-8")); /* x좌표(소수점 15) */
		urlBuilder.append(
				"&" + URLEncoder.encode("yPos", "UTF-8") + "=" + URLEncoder.encode("", "UTF-8")); /* y좌표(소수점 15) */
		urlBuilder.append(
				"&" + URLEncoder.encode("radius", "UTF-8") + "=" + URLEncoder.encode("3000", "UTF-8")); /* 단위 : 미터(m) */
	...
	public ResponseEntity<String> medicalList(HttpServletRequest request) throws Exception {
		...
		urlBuilder
				.append("&" + URLEncoder.encode("Q1", "UTF-8") + "=" + URLEncoder.encode(sigun, "UTF-8")); /* 주소(시군구) */

		urlBuilder.append(
				"&" + URLEncoder.encode("QT", "UTF-8") + "=" + URLEncoder.encode("", "UTF-8")); /* 월~일요일, 공휴일: 1~8 */
	...
	public ResponseEntity<String> hospitalFacilityInfo(HttpServletRequest request) throws Exception {
		...
		StringBuilder urlBuilder = new StringBuilder(
				"http://apis.data.go.kr/B551182/medicInsttDetailInfoService/getFacilityInfo"); /* URL */
		urlBuilder.append("?" + URLEncoder.encode("ServiceKey", "UTF-8")
				+ "=h1WoDyOi4e8rhTTYSuSJmN5H5sMOoJZhuTOsYTgxzzOEJaarD%2FrWJBttt15QA9Dw5h9Tj4%2BslQNc7eTa49aOOg%3D%3D"); /*
																														 * Service
																														 * Key
	...
	public ResponseEntity<String> hospitalSbjectInfoList(HttpServletRequest request) throws Exception {
		...
		StringBuilder urlBuilder = new StringBuilder(
				"http://apis.data.go.kr/B551182/medicInsttDetailInfoService/getMdlrtSbjectInfoList"); /* URL */
		urlBuilder.append("?" + URLEncoder.encode("ServiceKey", "UTF-8")
				+ "=h1WoDyOi4e8rhTTYSuSJmN5H5sMOoJZhuTOsYTgxzzOEJaarD%2FrWJBttt15QA9Dw5h9Tj4%2BslQNc7eTa49aOOg%3D%3D"); /*
																														 * Service
																														 * Key
	...
	public ResponseEntity<String> hospitalMdlrtInfoList(HttpServletRequest request) throws Exception {
		...
		StringBuilder urlBuilder = new StringBuilder(
				"http://apis.data.go.kr/B551182/medicInsttDetailInfoService/getSpclMdlrtInfoList"); /* URL */
		urlBuilder.append("?" + URLEncoder.encode("ServiceKey", "UTF-8")
				+ "=h1WoDyOi4e8rhTTYSuSJmN5H5sMOoJZhuTOsYTgxzzOEJaarD%2FrWJBttt15QA9Dw5h9Tj4%2BslQNc7eTa49aOOg%3D%3D"); /*
																														 * Service
																														 * Key
	...
	public ResponseEntity<String> hospitalTransport(HttpServletRequest request) throws Exception {
		...
		StringBuilder urlBuilder = new StringBuilder(
				"http://apis.data.go.kr/B551182/medicInsttDetailInfoService/getTransportInfoList"); /* URL */
		urlBuilder.append("?" + URLEncoder.encode("ServiceKey", "UTF-8")
				+ "=h1WoDyOi4e8rhTTYSuSJmN5H5sMOoJZhuTOsYTgxzzOEJaarD%2FrWJBttt15QA9Dw5h9Tj4%2BslQNc7eTa49aOOg%3D%3D"); /*
																														 * Service
																														 * Key
	...
	public ResponseEntity<String> hospitalEquipmentInfoList(HttpServletRequest request) throws Exception {
		...
		StringBuilder urlBuilder = new StringBuilder(
				"http://apis.data.go.kr/B551182/medicInsttDetailInfoService/getMedicalEquipmentInfoList"); /* URL */
		urlBuilder.append("?" + URLEncoder.encode("ServiceKey", "UTF-8")
				+ "=h1WoDyOi4e8rhTTYSuSJmN5H5sMOoJZhuTOsYTgxzzOEJaarD%2FrWJBttt15QA9Dw5h9Tj4%2BslQNc7eTa49aOOg%3D%3D"); /*
																														 * Service
																														 * Key
	...
	public ResponseEntity<String> hospitalhospitalSearch(HttpServletRequest request) throws Exception {
		...
		urlBuilder
				.append("&" + URLEncoder.encode("sgguCd", "UTF-8") + "=" + URLEncoder.encode("", "UTF-8")); /* 시군구코드 */

		urlBuilder
				.append("&" + URLEncoder.encode("emdongNm", "UTF-8") + "=" + URLEncoder.encode("", "UTF-8")); /* 읍면동명 */
		urlBuilder.append("&" + URLEncoder.encode("yadmNm", "UTF-8") + "="
		...
		urlBuilder.append("&" + URLEncoder.encode("clCd", "UTF-8") + "=" + URLEncoder.encode("", "UTF-8")); /* 종별코드 */
		urlBuilder.append(
				"&" + URLEncoder.encode("dgsbjtCd", "UTF-8") + "=" + URLEncoder.encode("", "UTF-8")); /* 진료과목코드 */
