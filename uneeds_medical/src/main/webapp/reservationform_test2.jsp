...
var calendar = {
		...
		init: function(ajax) {
	      ...
	      $.ajax({
	  				url: '../resources/Creating/demo/data/events.json',
	  				type: 'GET',
	  			})
	  			.done(function(data) {
	    ...
	    var mon = 'Mon';
			...
			function printDateNumber(monthNumber, mon, tue, wed, thur, fri, sat, sund) {
				...
				function setDaysInOrder(mon, tue, wed, thur, fri, sat, sund) {
					...
					if (monthDay === 'Mon') {
						$('thead.event-days tr').append('<td><span class="impossible first">' + mon + '</span></td><td><span class="impossible">' + tue + '<span class="impossible"></span></td><td><span class="impossible">' + wed + '</span></td><td><span class="impossible">' + thur + '</span></td><td><span class="impossible">' + fri + '</span></td><td><span class="impossible">' + sat + '</span></td><td><span class="impossible last">' + sund + '</span></td>');
					} else if (monthDay === 'Tue') {
						$('thead.event-days tr').append('<td><span class="impossible first">' + tue + '</span></td><td><span class="impossible">' + wed + '</td><td>' + thur + '</span></td><td><span class="impossible">' + fri + '</span></td><td><span class="impossible">' + sat + '</span></td><td><span class="impossible">' + sund + '</span></td><td><span class="impossible last">' + mon + '</span></td>');
					} else if (monthDay === 'Wed') {
						$('thead.event-days tr').append('<td><span class="impossible first">' + wed + '</span></td><td><span class="impossible">' + thur + '</td><td>' + fri + '</span></td><td><span class="impossible">' + sat + '</span></td><td><span class="impossible">' + sund + '</span></td><td><span class="impossible">' + mon + '</span></td><td><span class="impossible last">' + tue + '</span></td>');
					} else if (monthDay === 'Thu') {
						$('thead.event-days tr').append('<td><span class="impossible first">' + thur + '</span></td><td><span class="impossible">' + fri + '</td><td>' + sat + '</span></td><td><span class="impossible">' + sund + '</span></td><td><span class="impossible">' + mon + '</span></td><td><span class="impossible">' + tue + '</span></td><td><span class="impossible last">' + wed + '</span></td>');
					} else if (monthDay === 'Fri') {
						$('thead.event-days tr').append('<td><span class="impossible first">' + fri + '</span></td><td><span class="impossible">' + sat + '</td><td>' + sund + '</span></td><td><span class="impossible">' + mon + '</span></td><td><span class="impossible">' + tue + '</span></td><td><span class="impossible">' + wed + '</span></td><td><span class="impossible last">' + thur + '</span></td>');
					} else if (monthDay === 'Sat') {
						$('thead.event-days tr').append('<td><span class="impossible first">' + sat + '</span></td><td><span class="impossible">' + sund + '</td><td>' + mon + '</span></td><td><span class="impossible">' + tue + '</span></td><td><span class="impossible">' + wed + '</span></td><td><span class="impossible">' + thur + '</span></td><td><span class="impossible last">' + fri + '</span></td>');
					} else if (monthDay === 'Sun') {
						$('thead.event-days tr').append('<td><span class="impossible first">' + sund + '</span></td><td><span class="impossible">' + mon + '</td><td>' + tue + '</span></td><td><span class="impossible">' + wed + '</span></td><td><span class="impossible">' + thur + '</span></td><td><span class="impossible">' + fri + '</span></td><td><span class="impossible last">' + sat + '</span></td>');
					}
				};
...
<a  href="#" class="btn-prev fontawesome-angle-left"><img src="../resources/medical/img/arrow05.gif"></a>
<h2 class="month"></h2>
	
	<a  href="#" class="btn-next fontawesome-angle-right" ><img src="../resources/medical/img/arrow06.gif"></a>
